            ...
            <div class="brand">
                <a href="http://localhost/shopbanhanglaravel/index.html" class="logo">
                    ...
                    <!--search & user info start-->
                        ...
                        <!-- user login dropdown start-->
                    </a><li class="dropdown"><a href="http://localhost/shopbanhanglaravel/index.html" class="logo">
                        </a><a data-toggle="dropdown" class="dropdown-toggle" href="http://localhost/shopbanhanglaravel/add-category-product#">
                            <img alt="" src="./DashboardCSS/2.png">
                            <span class="username">
								Lâm Minh Thiện
							</span>
                        ...
                        <ul class="dropdown-menu extended logout">
                            <li><a href="http://localhost/shopbanhanglaravel/add-category-product#"><i class=" fa fa-suitcase"></i>Thông tin</a></li>
                            <li><a href="http://localhost/shopbanhanglaravel/add-category-product#"><i class="fa fa-cog"></i> Cài đặt</a></li>
                            <li><a href="http://localhost/shopbanhanglaravel/logout"><i class="fa fa-key"></i> Đăng xuất</a></li>
                        </ul>
                    </li>
                    <!-- user login dropdown end -->
